#in this file we calculate the log2 fold change for the normal and cancer samples and perform the t-test to find the significant genes
#we also perform the false discovery rate correction to find the significant genes
...
#load final merged dataset post preprocessing
...
#calculating log2 fold change and adding it to the data_means dataframe
